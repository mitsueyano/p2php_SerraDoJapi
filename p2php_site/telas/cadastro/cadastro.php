...
<body>
    ...
    <div id="navbar">
        ...
        <a href="../login/login.php" id="selected">ENTRE / CADASTRE-SE</a>
    </div>
    <div id="conteudo">
         <div id="caixa">
           <form action="../..//php_funcoes/cadastrar.php" method="post">
                ...
                <div class="flex">
                    ...
                    <div class="caixinha"><input type="text" name="email" required></div>
                </div>
                <div class="flex">
                    <div class="caixinha"><label for="senha">Senha:</label></div>
                    <div class="caixinha"><input type="text" name="senha" required></div>
                </div>
                <div class="flex">
                    <div class="caixinha"><label for="senha2">Repita a senha:</label></div>
                    <div class="caixinha"><input type="text" name="senha2" required></div>
                </div>
                <div class="flex">
                    <div class="caixinha">
